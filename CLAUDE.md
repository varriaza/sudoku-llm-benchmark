...
├── puzzles/trivial_puzzles.json   ← hardcoded 2-cell puzzle for smoke testing (do not edit)
...
│   ├── parser.py                  ← parses LLM text output into a Board; strips <think> blocks, handles code fences
